...
#nullable enable
    ...
    public abstract class BubbleContentView : MonoBehaviour
    {
        ...
        public abstract YarnTask DismissContent(Bubble.BubbleContent content, System.Threading.CancellationToken cancellationToken);
        ...
        public IAsyncTypewriter? typewriter;
    }
}
