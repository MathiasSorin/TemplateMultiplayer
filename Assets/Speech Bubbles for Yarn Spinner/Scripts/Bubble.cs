...
#nullable enable
    ...
    public sealed class Bubble : MonoBehaviour
    {
        ...
        public CharacterBubbleAnchor? Target
        {
            ...
            set
            {
                if (contentView != null)
                {
                    if (value != null)
                    {
                        contentView.SetCharacter(value.characterBubbleData);
                    }
                    else
                    {
                        contentView.SetCharacter(null);
                    }
                }
        ...
        /// </remarks>
        public BubbleContentView? contentView;
        ...
        private void ApplyPresentationFactor()
        {
            ...
            if (contentView != null)
            {
                contentView.PresentationFactor = this.State.presentationFactor;
            }
        }
        ...
        void Start()
        {
            ...
            if (this.contentView != null)
            {
                ...
                this.contentView.SetContentWithoutAnimation(BubbleContent.None);
            }
        ...
        public Vector2 GetContentSize(BubbleContent bubbleContent)
        {
            ...
            {
                return contentView.GetContentSize(bubbleContent);
            }
        }
        ...
        internal async YarnTask PresentBubble(BubbleContent content, float duration, System.Threading.CancellationToken cancellationToken)
        {
            ...
            if (this.contentView == null)
            {
                Debug.LogError($"Can't present bubble, because {nameof(Bubble.contentView)} is null!", this);
                return;
            }

            this.State.content = content;

            this.contentView.PrepareForContent(content);

            // Calculate the size of the content, and update the bubble's
            // dimensions accordingly.
            var size = this.contentView.GetContentSize(content);
            ...
            if (this.contentView != null)
            {
                await this.contentView.PresentContent(content, cancellationToken);
            }
        }
        ...
        internal async YarnTask DismissBubble(float duration, System.Threading.CancellationToken token)
        {
            if (this.contentView != null)
            {
                await this.contentView.DismissContent(this.State.content, token);
            }
        ...
        internal async YarnTask UpdateBubble(BubbleContent content, float duration, System.Threading.CancellationToken token)
        {
            ...
            // update and prepare to show the new content
            this.State.content = content;
            ...
            var endSize = this.contentView.GetContentSize(content);
            ...
            await this.contentView.PresentContent(content, token);
        }
        ...
        internal void UpdateBubbleImmediate(BubbleContent content)
        {
            ...
            this.contentView.SetContentWithoutAnimation(content);
